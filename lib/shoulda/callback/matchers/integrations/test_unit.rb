...
if defined?(Test::Unit::TestCase) && (defined?(::ActiveModel) || defined?(::ActiveRecord))
  ...
  Test::Unit::TestCase.tap do |test_unit|
    test_unit.include Shoulda::Callback::Matchers::ActiveModel
    test_unit.extend Shoulda::Callback::Matchers::ActiveModel
  end
  ...
  MiniTest::Unit::TestCase.tap do |minitest_unit|
    minitest_unit.include Shoulda::Callback::Matchers::ActiveModel
    minitest_unit.extend Shoulda::Callback::Matchers::ActiveModel
  end
